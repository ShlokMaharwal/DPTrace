export const meta = {
  ...
  approaches: {
    ...
    spaceOptimized: { label: 'Space Optimized', shortLabel: 'Opt', description: 'Process one coin at a time. Watch how each new denomination ripples through and improves our previous answers.', time: 'O(amount × coins)', space: 'O(amount)', visualizer: 'table1d' },
  },
  insights: [
